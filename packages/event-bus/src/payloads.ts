...
export type TopicPayloadMap = {
  ...
  "GRAPHICS.SELECTION_SET_CHANGED": GraphicsSelectionSetPayload;
  ...
  "INPUT.TRANSFORM_HANDLE_START": InputTransformHandleStartPayload;
  "INPUT.TRANSFORM_HANDLE_DRAG": InputTransformHandleDragPayload;
  "INPUT.TRANSFORM_HANDLE_END": InputTransformHandleEndPayload;
